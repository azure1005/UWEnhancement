...
#LW#  from UW.utils import Config
...
#LW#                                       save_ensemble_image, save_ensemble_image_8)
...
def parse_args():
    ...
    parser.add_argument('--config',type=str,
                        default='/home/lw/Works_DL_linux/UWE/UW/config/UWCNN.py',
                        help='train config file path')
    parser.add_argument('--load_from',
                        default='/home/lw/Works_DL_linux/UWE/UW/checkpoints/UWCNN/UWCNN_type3.pth',
