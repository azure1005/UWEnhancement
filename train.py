...
import collections
import visdom
#LW# from UW.utils.read_file import Config
...
#LW# from UW.utils.save_image import normimage, normPRED
...
def parse_args():
    ...
    parser.add_argument('--config',type=str, default='/home/lw/Works_DL_linux/UWE/UW/config/UWCNN.py',
